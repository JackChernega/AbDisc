...
public class DefaultParameters {
    public static final byte SENSOR_DATA_PIN= 0, SENSOR_GROUND_PIN= 1, SEDENTARY_TIME= 16;
    public static final float CRUNCH_SESSION_DURATION= 120.f, L1_HAPTIC_STRENGTH= 40.f, L2_HAPTIC_STRENGTH= 70.f, L3_HAPTIC_STRENGTH= 90.f;
